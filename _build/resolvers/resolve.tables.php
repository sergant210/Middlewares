...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('middlewares_core_path', null,
                    $modx->getOption('core_path') . 'components/middlewares/') . 'model/';
            $modx->addPackage('middlewares', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/middlewares/model/schema/middlewares.mysql.schema.xml';
